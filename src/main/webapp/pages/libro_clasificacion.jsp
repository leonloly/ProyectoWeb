...
<div id="vue-app" class="card-body">
    ...
    <b-form-group label="Nombre: *" label-for="nombre">
        ...
        <b-form-invalid-feedback>Nombre de la clasificacion</b-form-invalid-feedback>
    </b-form-group>
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        new Vue({
            ...
            methods: {
                ...
                async getLibroClasificacion() {
                    const {status, data} = await httpClient.get("/Proyecto2/LibroClasificacion-Controller", this.form);
                    this.table.data = data;
                },
                async save() {
                    if (this.valid()) {
                        const {status} = await httpClient.post("/Proyecto2/LibroClasificacion-Controller", this.form);
                        console.log(status);
                        if (status) {
                            this.getLibroClasificacion();
                            this.form = {};
                        }
                    }
                },
