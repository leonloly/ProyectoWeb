...
/**
  * @author MariaLeon
 */
@WebServlet(name = "LibroClasificacionController", urlPatterns = {"/LibroClasificacion-Controller"})
public class LibroClasificacionController extends HttpServlet{
    ...
    private String list(Map response) {
        LibroClasificaciones p = new LibroClasificaciones();
