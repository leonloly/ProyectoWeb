...
<div id="vue-app" class="card-body">
    ...
    <b-form-group label="Nombre: *" label-for="nombre">
        ...
        <b-form-invalid-feedback>Nombre del tema</b-form-invalid-feedback>
    </b-form-group>
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        new Vue({
            ...
            methods: {
                ...
                async getTemas() {
                    const {status, data} = await httpClient.get("/Proyecto2/Temas-controller", this.form);
                    this.table.data = data;
                },
                async save() {
                    if (this.valid()) {
                        const {status} = await httpClient.post("/Proyecto2/Temas-controller", this.form);
                        console.log(status);
                        if (status) {
                            this.getPaises();
                            this.form = {};
